...
@Composable
fun ProblemasScreen(navController: NavController){
    ...
    Scaffold(
        ...
        bottomBar = {
            val selectedDestination = remember { mutableStateOf("Problemas") }
            NavegacionInf(
        ...
        Column(
            ...
            Column(
                ...
                Row(
                    ...
                    Text(text = "Reportar Problemas", fontSize = 40.sp, fontWeight = FontWeight.ExtraBold)
                }
            }
        }
    }
